...
<div class="content-wrapper pb-0">
    ...
    <div class="row">
      <div class="col-sm-4 col-xl-2 stretch-card grid-margin">
        <div class="card">
          <div class="card-body">
            <div class="d-flex border-bottom mb-4 pb-2">
              ...
              <div class="ps-4">
                <h4 class="font-weight-bold text-warning mb-0"> {{ $matapilihs->count() }} </h4>
                <h6 class="text-muted">Total Matapilih</h6>
              </div>
            </div>
            <div class="d-flex border-bottom mb-4 pb-2">
              <div class="hexagon">
              ...
              <div class="ps-4">
                <h4 class="font-weight-bold text-danger mb-0">{{ $koordinators->count() }}</h4>
                <h6 class="text-muted">Total Koordinator</h6>
              </div>
            </div>
            <div class="d-flex border-bottom mb-4 pb-2">
              <div class="hexagon">
              ...
              <div class="ps-4">
                <h4 class="font-weight-bold text-success mb-0"> {{ $palembang_sum }} </h4>
                <h6 class="text-muted">Palembang</h6>
              </div>
            </div>
            <div class="d-flex border-bottom mb-4 pb-2">
              <div class="hexagon">
              ...
              <div class="ps-4">
                <h4 class="font-weight-bold text-info mb-0">{{ $banyuasin_sum }}</h4>
                <h6 class="text-muted">Banyuasin</h6>
              </div>
            </div>
            <div class="d-flex">
              <div class="hexagon">
              ...
              <div class="ps-4">
                <h4 class="font-weight-bold text-primary mb-0"> {{ $lubuklinggau_sum }} </h4>
                <h6 class="text-muted mb-0">Lubuk Linggau</h6>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          <div class="card-body">
            <div class="d-flex border-bottom mb-4 pb-2">
              ...
              <div class="ps-4">
                <h4 class="font-weight-bold text-success mb-0"> {{ $musibanyuasin_sum }} </h4>
                <h6 class="text-muted">Musi Banyuasin</h6>
              </div>
            </div>
            <div class="d-flex border-bottom mb-4 pb-2">
              <div class="hexagon">
              ...
              <div class="ps-4">
                ...
                <h6 class="text-muted">Musi Rawas</h6>
              </div>
            </div>
            <div class="d-flex">
              <div class="hexagon">
              ...
              <div class="ps-4">
                ...
                <h6 class="text-muted mb-0">Musi Rawas Utara</h6>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="row">
      <div class="col-sm-4 stretch-card grid-margin">
        <div class="card">
          <div class="card-body p-0">
            <img class="img-fluid w-100" src="{{ asset('plusadmin/images/dashboard/img_1.jpg') }}" alt="" />
          </div>
      ...
      <div class="col-sm-4 stretch-card grid-margin">
        <div class="card">
          <div class="card-body p-0">
            <img class="img-fluid w-100" src="{{ asset('plusadmin/images/dashboard/img_2.jpg') }}" alt="" />
          </div>
          <div class="card-body px-3 text-dark">
            <div class="d-flex justify-content-between">
              <p class="text-muted font-13 mb-0">ENTIRE APARTMENT</p>
      ...
      <div class="col-sm-4 stretch-card grid-margin">
        <div class="card">
          <div class="card-body p-0">
            <img class="img-fluid" src="{{ asset('plusadmin/images/dashboard/img_3.jpg') }}" alt="" />
          </div>
          <div class="card-body px-3 text-dark">
            <div class="d-flex justify-content-between">
              <p class="text-muted font-13 mb-0">ENTIRE APARTMENT</p>
            ...
            <div class="table-responsive">
              <table class="table custom-table text-dark">
                ...
                <tbody>
                  <tr>
                    <td>
                     <img src="{{ asset('plusadmin/images/faces/face2.jpg') }}" class="me-2" alt="image" /> Jacob Jensen 
                    </td>
                    <td>
                      <div class="d-flex">
                  ...
                  <tr>
                    <td>
                      <img src="{{ asset('plusadmin/images/faces/face3.jpg') }}" class="me-2" alt="image" /> Cecelia Bradley 
                    </td>
                    <td>
                      <div class="d-flex">
                  ...
                  <tr>
                    <td>
                      <img src="{{ asset('plusadmin/images/faces/face4.jpg') }}" class="me-2" alt="image" /> Leah Sherman 
                    </td> 
                    <td>
                      <div class="d-flex">
                  ...
                  <tr>
                    <td>
                      <img src="{{ asset('plusadmin/images/faces/face5.jpg') }}" class="me-2" alt="image" /> Ina Curry 
                    </td>
                    <td>
                      <div class="d-flex">
                  ...
                  <tr>
                    <td>
                      <img src="{{ asset('plusadmin/images/faces/face7.jpg') }}" class="me-2" alt="image" /> Lida Fitzgerald 
                    </td>
                    <td>
                      <div class="d-flex">
                  ...
                  <tr>
                    <td>
                      <img src="{{ asset('plusadmin/images/faces/face2.jpg') }}" class="me-2" alt="image" /> Stella Johnson 
                    </td>
                    <td>
                      <div class="d-flex">
                  ...
                  <tr>
                    <td>
                      <img src="{{ asset('plusadmin/images/faces/face9.jpg') }}" class="me-2" alt="image" /> Maria Ortiz 
                    </td>
                    <td>
                      <div class="d-flex">
                        <span class="pe-2 d-flex align-items-center">65%</span>
